...
class Example extends React.Component { 
  constructor(props) {
    ...
    this.mottoUpdate = event => this.mottoChange(event);
  }
  ...
  render() {
    return (
      ...
      <div className="container Example">
        ...
        <p> The name is {this.state.name}.<p id="motto"><i> &quot;{this.state.motto}.&quot
        </i></p> </p>
        <label> Put your own motto here:  </label>
        <input className="motto-update" type="text" value={this.state.motto} onChange={this.mottoUpdate}/>
        </div>
